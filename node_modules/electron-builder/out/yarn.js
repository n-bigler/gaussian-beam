...
let installOrRebuild = exports.installOrRebuild = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (options, appDir, electronVersion, arch) {
        ...
        if (forceInstall || !(yield (0, (_fs || _load_fs()).exists)(_path.join(appDir, "node_modules")))) {
            yield installDependencies(appDir, electronVersion, arch, args, !options.npmSkipBuildFromSource);
        } else {
            yield rebuild(appDir, electronVersion, arch, args, !options.npmSkipBuildFromSource);
        }
    });
...
let rebuild = exports.rebuild = (() => {
    var _ref2 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (appDir, electronVersion) {
        ...
        let buildFromSource = arguments[4];
    ...
    return function rebuild(_x8, _x9, _x10, _x11, _x12) {
...
function getGypEnv(electronVersion, arch, buildFromSource) {
