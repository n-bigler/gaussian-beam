...
class NsisTarget extends (_targetFactory || _load_targetFactory()).Target {
    ...
    buildInstaller() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const iconPath = (yield _this3.packager.getResource(_this3.options.installerIcon, "installerIcon.ico")) || (yield _this3.packager.getIconPath());
            ...
            if (_this3.packager.options.effectiveOptionComputed != null && (yield _this3.packager.options.effectiveOptionComputed([defines, commands]))) {
                return;
            }
