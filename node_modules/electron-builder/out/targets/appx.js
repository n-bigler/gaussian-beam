...
class AppXTarget extends (_targetFactory || _load_targetFactory()).Target {
    constructor(packager, outDir) {
        ...
        this.outDir = outDir;
        this.options = Object.assign({}, this.packager.platformSpecificBuildOptions, this.packager.devMetadata.build.appx);
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            }), (0, (_fs || _load_fs()).copyDir)(appOutDir, _path.join(preAppx, "app")), _this.writeManifest(templatePath, preAppx, safeName)]);
            ...
            yield (0, (_util || _load_util()).spawn)(_path.join((yield (0, (_windowsCodeSign || _load_windowsCodeSign()).getSignVendorPath)()), "windows-10", process.arch, "makeappx.exe"), args);
            yield packager.sign(destination);
            packager.dispatchArtifactCreated(destination, packager.generateName("appx", arch, true));
        })();
    }
    writeManifest(templatePath, preAppx, safeName) {
        var _this2 = this;
